...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 关注明细管理 <span
                class="c-gray en">&gt;</span> 关注明细列表 <a class="btn btn-success radius r btn-refresh"
                                                        ...
                                                        title="刷新"
                                                        onclick="location.replace('{{route('team.activity.voteFollowRecord')}}');"><i
                    class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">

        <div class="text-c">
            <form id="search_form"  action="{{route('team.activity.voteFollowRecord')}}" method="post" class="form-horizontal">
                {{csrf_field()}}
