<form class="form form-horizontal" id="form-edit">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input id="join_num" name="join_num" type="number" class="input-text"
                   value="{{ isset($data->join_num) ? $data->join_num : '0' }}" placeholder="请输入参与人数">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>投诉人数：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input id="complain_num" name="complain_num" type="number" class="input-text"
                   value="{{ isset($data->complain_num) ? $data->complain_num : '0' }}" placeholder="请输入投诉人数" disabled>
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>投票数：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input id="vote_num" name="vote_num" type="number" class="input-text"
                   value="{{ isset($data->vote_num) ? $data->vote_num : '0' }}" placeholder="请输入投票数" disabled>
        </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input id="show_num" name="show_num" type="number" class="input-text"
                   value="{{ isset($data->show_num) ? $data->show_num : '0' }}" placeholder="请输入展示次数" disabled>
        </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>分享次数：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input id="share_num" name="share_num" type="number" class="input-text"
                   value="{{ isset($data->share_num) ? $data->share_num : '0' }}" placeholder="请输入分享次数" disabled>
        </div>
    </div>
