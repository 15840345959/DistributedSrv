    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl">
                ...
                <span id="container" class="btn-upload form-group">
                    <input class="input-text upload-url radius" type="text" name=""
                           id="" value="" placeholder="请选择选手视频，视频名设置为选手名">
            ...
            <div class="row cl item c-999">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div>
                        <span>支持多选功能，一般选手视频名为选手名称，系统将自动摘取选手名称</span>
                    </div>
                </div>
            </div>
    ...
    <script id="message-content-template" type="text/x-dot-template">
        <div id="@{{=it.id}}" class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input name="video[]" id="video_@{{=it.id}}" type="text" class="input-text"
                       value="@{{=it.video}}" placeholder="选手作品" style="width: 450px;">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{route('team.activity.importVoteUser')}}",
                ...
                init: {
                    'FilesAdded': function (up, files) {
                        ...
                        for (var i = 0; i < vote_user_arr.length; i++) {
                            ...
                            vote_user_obj.video = "";
                            console.log("is_dom_exist:" + is_dom_exist(vote_user_obj.id) + " id:" + vote_user_obj.id);
                            //如果dom元素存在，说明已经加入了
...
//                        console.log("BeforeUpload up:" + up + " file:" + JSON.stringify(file));
                    ...
                    'UploadProgress': function (up, file) {
                        ...
                        layer.tips(file.percent, '#video_' + file.id);
                    },
                    'FileUploaded': function (up, file, info) {
                        ...
                        vote_user_obj.video = domain + res.key;
                        $("#video_" + key).val(domain + res.key);
