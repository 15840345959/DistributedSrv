...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 分享明细管理 <span
                class="c-gray en">&gt;</span> 分享明细列表 <a class="btn btn-success radius r btn-refresh"
                                                        ...
                                                        title="刷新"
                                                        onclick="location.replace('{{route('team.activity.voteShareRecord')}}');"><i
                    class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">

        <div class="text-c">
            <form id="search_form"  action="{{route('team.activity.voteShareRecord')}}" method="post" class="form-horizontal">
                {{csrf_field()}}
