...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 投票明细管理 <span
                class="c-gray en">&gt;</span> 投票明细列表 <a class="btn btn-success radius r btn-refresh"
                                                        ...
                                                        title="刷新"
                                                        onclick="location.replace('{{route('team.activity.voteRecord')}}');"><i
                    class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">

        <div class="text-c">
            <form id="search_form"  action="{{route('team.activity.voteRecord')}}" method="post" class="form-horizontal">
                {{csrf_field()}}
            ...
            <table class="table table-border table-bordered table-bg table-sort">
                ...
                @foreach($datas as $data)
                    <tr class="text-c">
                        ...
                        <td>
                            <span>{{$data->vote_user->name}}({{$data->vote_user->id}})</span>
                        </td>
                        <td>
