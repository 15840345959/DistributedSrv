            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="vote_num" name="vote_num" type="number" class="input-text"
                           value="{{ isset($data->vote_num) ? $data->vote_num : '0' }}" placeholder="票数" disabled>
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="show_num" name="show_num" type="number" class="input-text"
                           value="{{ isset($data->show_num) ? $data->show_num : '0' }}" placeholder="展示数" disabled>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="share_num" name="share_num" type="number" class="input-text"
                           value="{{ isset($data->share_num) ? $data->share_num : '0' }}" placeholder="展示数" disabled>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="fans_num" name="fans_num" type="number" class="input-text"
                           value="{{ isset($data->fans_num) ? $data->fans_num : '0' }}" placeholder="展示数" disabled>
                </div>
            </div>
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ route('team.activity.editVoteUser')}}",
