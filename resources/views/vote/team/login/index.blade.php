...
<div class="login">
    <div class="message font-size-22 text-white">ISART-地推团队管理后台</div>
    <div id="darkbannerwrap"></div>

    <form action="{{route('team.login')}}" method="post" onsubmit="return checkValid()">
        {{csrf_field()}}
...
<div class="copyright">© 2017-2018 by
    <a href="#" target="_blank" style=" color: rgba(255, 255, 255, 0.85);">ISART</a>
</div>
