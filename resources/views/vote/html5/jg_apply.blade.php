...
@section('content')
    ...
    <div style="background: white;">
        <div class="aui-padded-t-15">
            <span class="aui-font-size-16 aui-margin-l-15" style="font-weight: bolder;">机构报名</span>
        </div>
        <ul class="aui-list aui-form-list aui-margin-l-10 aui-font-size-14 aui-margin-t-10 aui-list-noborder"
            ...
            <li class="aui-list-item" style="border: none !important;background: white;">
                ...
                <div class="aui-list-item-inner" style="">
                    <input id="name" name="name" type="text" placeholder="请输入选手姓名" class="aui-input aui-font-size-14"
                           value="">
                </div>
            </li>
        </ul>
        ...
        <script id="works-content-template" type="text/x-dot-template">
            @{{for(var i=0;i
            <it.length ;i++){}}
            <div id="work_@{{=i}}" class="aui-col-xs-4">
        ...
        <div class="aui-margin-t-5 aui-text-center">
            <span class="main-color aui-font-size-14" onclick="clickGRApply({{$activity->id}});">个人报名</span>
        </div>
    </div>
...
//                        consoledebug.log($("#pickfiles").attr('src'));
        ...
        //点击机构报名
        function clickGRApply(activity_id) {
            toast_loading("个人报名...");
            window.location.href = "{{URL::asset('/vote/apply')}}?activity_id=" + activity_id + "&jg_flag=0";
        }
