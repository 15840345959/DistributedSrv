...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 广告图管理 <span
                class="c-gray en">&gt;</span> 广告图列表 <a class="btn btn-success radius r btn-refresh"
                                                       ...
                                                       title="刷新"
                                                       onclick="location.replace('{{URL::asset('/admin/vote/voteAD/index')}}');"><i
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                 <a href="javascript:;"
                    onclick="edit('添加广告图','{{URL::asset('/admin/vote/voteAD/edit')}}')"
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-sort">
                <thead>
                <tr>
                    <th scope="col" colspan="9">广告图列表<span
                ...
                @foreach($datas as $data)
                    <tr class="text-c">
                        ...
                        <td>{{$data->id}}</td>
                        <td>
                            <img src="{{ $data->img ? $data->img.'?imageView2/1/w/60/h/40/interlace/1/q/75|imageslim' : URL::asset('/img/upload_rect.png')}}">
                        </td>
                        <td>
                            {{$data->title}}
                        </td>
                        ...
                        <td>
                            <span class="c-primary">{{$data->mode_str}}</span>
                        </td>
                        <td>
                            {{$data->admin->name}}
                        </td>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="javascript:;"
                               onclick="edit('编辑广告图','{{URL::asset('/admin/vote/voteAD/edit')}}?id={{$data->id}})',{{$data->id}})"
    ...
    <script type="text/javascript">
        ...
        function stop(obj, id) {
            ...
            layer.confirm('确认要停用吗？', function (index) {
                ...
                //从后台设置广告图状态
                vote_voteAD_setStatus('{{URL::asset('')}}', param, function (ret) {
                    if (ret.status == true) {
