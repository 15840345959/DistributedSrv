...
@section('content')
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl hidden">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data->id) ? $data->id : '' }}" placeholder="投票礼品id">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text"
                           value="{{ isset($data->name) ? $data->name : '' }}" placeholder="礼品名称">
                </div>
            </div>
            <div class="row cl item">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <div id="container" class="margin-top-10">
                        <img id="pickfiles"
                             src="{{ isset($data->img) ? $data->img : URL::asset('/img/upload_rect.png') }}"
                             style="width: 150px;">
                    </div>
            ...
            <div class="row cl item">
                <label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>礼品价格：</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input id="price" name="price" type="number" class="input-text" style="width: 150px;"
                           value="{{ isset($data->price) ? $data->price : '' }}" placeholder="请输入价格">
                    <label>元</label>
                </div>
                <label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>核算票数：</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input id="as_vote_num" name="as_vote_num" type="number" class="input-text" style="width: 150px;"
                           value="{{ isset($data->as_vote_num) ? $data->as_vote_num : '' }}" placeholder="请核算票数">
                    <label>票</label>
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl item">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea id="desc" name="desc" class="textarea" placeholder="请输入礼品描述..." rows=""
                              cols="">{{ isset($data->desc) ? $data->desc : '' }}</textarea>
                </div>
            </div>
            <div class="row cl mt-20">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <button class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存礼品
                    </button>
                </div>
            </div>
        </form>
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/vote/voteGift/edit')}}",
