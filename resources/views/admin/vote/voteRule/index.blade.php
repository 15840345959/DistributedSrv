...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 大赛规则管理 <span
                class="c-gray en">&gt;</span> 大赛规则列表 <a class="btn btn-success radius r btn-refresh"
                                                        style="line-height:1.6em;margin-top:3px"
                                                        title="刷新"
                                                        onclick="location.replace('{{URL::asset('/admin/vote/voteRule/index')}}');"><i
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                 <a href="javascript:;"
                    onclick="edit('添加大赛规则','{{URL::asset('/admin/vote/voteRule/edit')}}')"
                    class="btn btn-primary radius">
                     <i class="Hui-iconfont">&#xe600;</i> 添加大赛规则
                 </a>
            </span>
                    ...
                    <tr class="text-c">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="javascript:;"
                               onclick="edit('编辑大赛规则','{{URL::asset('/admin/vote/voteRule/edit')}}?id={{$data->id}})',{{$data->id}})"
    ...
    <script type="text/javascript">
        ...
        function stop(obj, id) {
            ...
            layer.confirm('确认要停用吗？', function (index) {
                ...
                //从后台设置大赛规则状态
                vote_VoteRule_setStatus('{{URL::asset('')}}', param, function (ret) {
                    if (ret.status == true) {
