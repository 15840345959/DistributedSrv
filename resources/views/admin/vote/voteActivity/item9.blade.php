                ...
                <td class="td-manage">
                    <div>
                        ...
                        <a title="编辑" href="javascript:;"
                           onclick="edit('编辑参赛选手-{{$vote_user->name}}','{{URL::asset('/admin/vote/voteUser/edit')}}?id={{$vote_user->id}}',{{$vote_user->id}})"
                    ...
                    <div class="mt-5">
                        <a class="c-primary" style="text-decoration:none"
                           onclick="creatIframe('{{URL::asset('/admin/vote/voteUser/info')}}?id={{$vote_user->id}}', '选手信息-{{$vote_user->name}}');">
                            详细信息
                        </a>
                    </div>
                    <div class="mt-5">
