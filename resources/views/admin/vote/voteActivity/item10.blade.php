    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input id="vote_num" name="vote_num" type="number" class="input-text"
                   value="{{ isset($data->vote_num) ? $data->vote_num : '0' }}" placeholder="请输入投票数">
        </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input id="show_num" name="show_num" type="number" class="input-text"
                   value="{{ isset($data->show_num) ? $data->show_num : '0' }}" placeholder="请输入展示次数">
        </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input id="share_num" name="share_num" type="number" class="input-text"
                   value="{{ isset($data->share_num) ? $data->share_num : '0' }}" placeholder="请输入分享次数">
        </div>
    </div>
