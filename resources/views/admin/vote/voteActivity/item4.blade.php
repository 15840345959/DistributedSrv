<form class="form form-horizontal" id="form-edit">
    ...
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2">参赛说明：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <script id="apply_html" name="apply_html" type="text/plain">
                @if(isset($data->apply_html))
                    {!! $data->apply_html !!}
                @endif
            </script>
        </div>
...
<script type="text/javascript">
    ...
    //初始化编辑器
    var ue = UE.getEditor('apply_html', {
