...
@section('content')
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl hidden">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data->id) ? $data->id : '' }}" placeholder="奖品id">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>奖品类型：</label>
                <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box" style="width: 200px;">
                    <select id="type" name="type" class="select">
                        <option value="">请选择</option>
                        @foreach(\App\Components\Utils::YXHD_PRIZE_TYPE_VAL as $key=>$value)
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="total_num" name="total_num" type="number" class="input-text"
                           value="{{ isset($data->total_num) ? $data->total_num : '0' }}" placeholder="库存数量">
                </div>
            </div>
            <div class="row cl item">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>奖品图片：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <div style="font-size: 12px;margin-top: 10px;" class="c-999">*请上传400*400比例尺寸图片</div>
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl mt-20">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <button class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存奖品
                    </button>
                </div>
            </div>
        </form>
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/yxhd/yxhdPrize/edit')}}",
