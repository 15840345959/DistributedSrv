...
@section('content')
    ...
    <nav class="breadcrumb">活动管理 <a class="btn btn-success radius r btn-refresh"
                                    ...
                                    title="刷新"
                                    onclick="location.replace('{{URL::asset('/admin/yxhd/yxhdActivity/edit')}}?item={{$item}}&id={{isset($data)?$data->id:''}}');"><i
    ...
    <div class="page-container">
        <div class="btn-group text-c">
            ...
            <span class="btn {{$item==1?'btn-primary':'btn-default'}} radius"
                  onclick="selectItem(1)">奖品配置</span>
        ...
        {{--通过item控制显示选项--}}
        @if($item=='0')
            @include('admin.yxhd.yxhdActivity.item0')
        @endif
        @if($item=='1')
            @include('admin.yxhd.yxhdActivity.item1')
        @endif
        @if($item=='2')
            @include('admin.yxhd.yxhdActivity.item2')
        @endif
        @if($item=='3')
            @include('admin.yxhd.yxhdActivity.item3')
        @endif
        @if($item=='4')
            @include('admin.yxhd.yxhdActivity.item4')
        @endif
...
@section('script')
    <script type="text/javascript">
        ...
        function selectItem(item) {
            ...
            location.replace('{{URL::asset('/admin/yxhd/yxhdActivity/edit')}}?id={{$data->id}}&item=' + item);
        }
