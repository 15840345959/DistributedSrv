...
@section('content')
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户openid：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="to_openid" name="to_openid" type="text" class="input-text"
                           value="{{ isset($data->to_openid) ? $data->to_openid : '' }}" placeholder="请输入用户openid">
                </div>
            </div>
            <div class="row cl item text-item">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>消息内容：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea id="content" name="content" class="textarea" placeholder="请输入定向客服消息内容..." rows=""
            ...
            <div class="row cl item text-item">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div>
                        <span class="c-primary">请慎重发送定向客服消息，每个用户可以发送20条消息，当用户有回复公众号、点击菜单等动作时，发送消息数清零</span>
                    </div>
                    <div class="mt-15">
            ...
            <div class="row cl mt-20">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <button class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 发送定向客服消息
                    </button>
                </div>
            </div>
        </form>
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/gzh/directMessage/edit')}}",
