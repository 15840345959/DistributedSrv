...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 公众号业务话术管理 <span
                class="c-gray en">&gt;</span> 公众号业务话术列表 <a class="btn btn-success radius r btn-refresh"
                                                           style="line-height:1.6em;margin-top:3px"
                                                           title="刷新"
                                                           onclick="location.replace('{{URL::asset('/admin/gzh/busiWord/index')}}?busi_name={{$con_arr['busi_name']}}');"><i
                    class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <div class="text-c">
            <form id="search_form"  action="{{URL::asset('/admin/gzh/busiWord/index')}}" method="post" class="form-horizontal">
                {{csrf_field()}}
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                 <a href="javascript:;"
                    onclick="edit('添加业务话术','{{URL::asset('/admin/gzh/busiWord/edit')}}?busi_name={{$con_arr['busi_name']}}')"
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-sort">
                <thead>
                <tr>
                    <th scope="col" colspan="9">公众号业务话术列表</th>
                </tr>
                <tr class="text-c">
                    ...
                    <tr class="text-c">
                        ...
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;"
                               onclick="edit('编辑业务话术','{{URL::asset('/admin/gzh/busiWord/edit')}}?busi_name={{$con_arr['busi_name']}}&id={{$data->id}})',{{$data->id}})"
    ...
    <script type="text/javascript">
        ...
        function del(obj, id, busi_name) {
            layer.confirm('确认要删除吗？', function (index) {
                ...
                busiWord_del('{{URL::asset('')}}', param, function (ret) {
                    if (ret.result == true) {
