...
@section('content')
    <div class="page-container">
        <form class="form form-horizontal" id="form-admin-add">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>操作动作：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text"
                           value="{{ isset($data->name) ? $data->name : '' }}" placeholder="请输入操作动作">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>操作值：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="value" name="value" type="text" class="input-text" style="width: 100%;"
                           value="{{ isset($data->value) ? $data->value : '' }}" placeholder="请输入操作值（系统预设不可更改）">
                </div>
            </div>
