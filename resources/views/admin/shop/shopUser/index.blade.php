...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户列表管理 <span
                class="c-gray en">&gt;</span> 用户列表 <a class="btn btn-success radius r btn-refresh"
                                                      ...
                                                      title="刷新"
                                                      onclick="location.replace('{{URL::asset('/admin/shop/shopUser/index')}}');"><i
                    class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">

        <div class="text-c">
            <form id="search_form"  action="{{URL::asset('/admin/shop/shopUser/index')}}" method="post" class="form-horizontal">
                {{csrf_field()}}
...
@section('script')
    <script type="text/javascript">
         ...
         * 2018-09-21
         */
        function showJoinInfo(user_id, nick_name) {
            creatIframe("{{URL::asset('/admin/shop/shopJoin/index')}}?user_id=" + user_id, "作品明细-" + nick_name);
        }
