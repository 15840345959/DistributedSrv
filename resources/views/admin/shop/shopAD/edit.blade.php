    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 350px;">
                            <select id="position" name="position" class="select">
                                ...
                                @foreach(\App\Components\Utils::AD_POSITION_VAL as $key=>$value)
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div>
                        <span class="c-999">广告位置决定了在用户端广告的展示位置，如果运营组有需求请联系TerryQi</span>
                    </div>
                    <div class="mt-5">
                        <span class="c-999">0位置：小艺商城商品列表页面的轮播图</span>
                    </div>
                    <div class="mt-5">
                        <span class="c-999">1位置：小艺商城发现页面的背景图，系统更将获取最近一条数据</span>
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 400px;">
                        <select id="type" name="type" class="select">
                            @foreach(\App\Components\Utils::YSB_AD_TYPE_VAL as $key=>$value)
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div>
                        <span class="c-999">随着业务得发展，将丰富跳转目标的形式，如有需求请联系TerryQi</span>
                    </div>
                    <div class="mt-5">
                        <span class="c-999">不跳转代表不进行页面跳转</span>
                    </div>
                    <div class="mt-5">
                        <span class="c-999">跳转链接可以输入一个url，这个url必须配置在小程序安全域名下，小程序必须新开一个页面来打开url</span>
                    </div>
                    <div class="mt-5">
                        <span class="c-999">跳转内容可以输入一段html代码，小程序将进行html内容的转义，在页面中展示</span>
                    </div>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">跳转目标：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="target" name="target" type="text" class="input-text"
                           value="{{ isset($data->target) ? $data->target : '' }}" placeholder="请输入跳转目标">
                </div>
            </div>
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/shop/shopAD/edit')}}",
