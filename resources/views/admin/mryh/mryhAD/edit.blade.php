        ...
        <form class="form form-horizontal" id="form-edit">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 400px;">
                        <select id="type" name="type" class="select">
                            @foreach(\App\Components\Utils::MRYH_AD_TYPE_VAL as $key=>$value)
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <div class="mt-5">
                        <span class="c-999">跳转链接可以输入一个page路径，请联系技术侧人员提供页面链接</span>
                    </div>
                    <div class="mt-5">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>跳转目标：</label>
                <div class="formControls col-xs-8 col-sm-9">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/mryh/mryhAD/edit')}}",
