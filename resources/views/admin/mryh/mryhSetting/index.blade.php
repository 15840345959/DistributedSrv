...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 业务配置管理 <span
                class="c-gray en">&gt;</span> 业务配置列表 <a class="btn btn-success radius r btn-refresh"
                                                        style="line-height:1.6em;margin-top:3px"
                                                        title="刷新"
                                                        onclick="location.replace('{{URL::asset('/admin/mryh/mryhSetting/index')}}');"><i
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                 <a href="javascript:;"
                    onclick="edit('添加业务配置','{{URL::asset('/admin/mryh/mryhSetting/edit')}}')"
                    class="btn btn-primary radius">
                     <i class="Hui-iconfont">&#xe600;</i> 添加业务配置
                 </a>
            </span>
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-sort">
                <thead>
                <tr>
                    <th scope="col" colspan="6">业务配置列表<span class="c-danger ml-10">系统将选取第一个生效的配置作为业务配置</span>
                        <span class="r">共有数据：<strong>{{$datas->total()}}</strong> 条</span></th>
                </tr>
                <tr class="text-c">
                    {{--<th width="25"><input type="checkbox" name="" value=""></th>--}}
                    <th width="40">ID</th>
                    <th width="350">业务配置名称</th>
                    <th width="50">创建人员</th>
                    ...
                    <tr class="text-c">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="javascript:;"
                               onclick="edit('编辑业务配置','{{URL::asset('/admin/mryh/mryhSetting/edit')}}?id={{$data->id}})',{{$data->id}})"
    ...
    <script type="text/javascript">
        ...
        function stop(obj, id) {
            ...
            layer.confirm('确认要停用吗？', function (index) {
                ...
                //从后台设置业务配置状态
                mryh_mryhSetting_setStatus('{{URL::asset('')}}', param, function (ret) {
                    if (ret.status == true) {
