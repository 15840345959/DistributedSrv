...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 作品类型管理 <span
                class="c-gray en">&gt;</span> 作品类型列表 <a class="btn btn-success radius r btn-refresh"
                                                        style="line-height:1.6em;margin-top:3px"
                                                        href="javascript:location.replace(location.href);" title="刷新"
                                                        onclick="location.replace('{{URL::asset('/admin/articleType/index')}}');"><i
                    class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">

        <div class="text-c">
            <form id="search_form" action="{{URL::asset('/admin/articleType/index')}}" method="post"
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                 <a href="javascript:;" onclick="articleType_edit('添加作品类型','{{ route('articleType.edit') }}')"
                    class="btn btn-primary radius">
                     <i class="Hui-iconfont">&#xe600;</i> 添加作品类型
                 </a>
            </span>
        </div>
        <table class="table table-border table-bordered table-bg table-sort mt-20">
            <thead>
            <tr>
                <th scope="col" colspan="7">作品类型列表</th>
            </tr>
            <tr class="text-c">
                <th width="40">ID</th>
                <th width="50">图标</th>
                ...
                <tr class="text-c">
                    ...
                    <td class="td-manage">
                        ...
                        <a title="编辑" href="javascript:;"
                           onclick="articleType_edit('作品类型编辑','{{ route('articleType.edit', ['id' => $data->id]) }}')"
...
@section('script')
    <script type="text/javascript">
        ...
        /*作品类型-编辑*/
        function articleType_edit(title, url, id) {
            console.log("articleType_edit url:" + url);
        ...
        function stop(obj, id) {
            ...
            layer.confirm('确认要隐藏吗？', function (index) {
                ...
                //从后台设置作品状态
                articleType_setStatus('{{URL::asset('')}}', param, function (ret) {
                    if (ret.result == true) {
                        $("#search_form").submit();
                    }
                })
