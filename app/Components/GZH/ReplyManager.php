...
class ReplyManager
{
     ...
     *
     */
    public static function setWechatMessage($reply, $user)
    {
        ...
        switch ($reply->type) {
            case "text":        //文本消息
                ...
                break;
            case "image":       //图片消息
                $image = new Image($reply->media_id);
                return $image;
                break;
            case "voice":       //语音消息
                $voice = new Voice($reply->media_id);
                return $voice;
                break;
            case "video":   //视频消息
                $video = new Video($reply->media_id, [
                    'title' => $reply->title,
